                ...
                <div class="post-container">
                  ...
                  <?php 
                           ...
                           $sql="SELECT * FROM post 
                                 ...
                                 WHERE post.title LIKE '%$search_term%' OR post.description LIKE '%$search_term%' OR category.category_name LIKE '%$search_term%' OR  user.username LIKE '%$search_term%' OR post.post_date LIKE '%$search_term%'
                                 LIMIT {$offset},{$limit}";
                   ...
                   <?php
                                       ...
                                       if(mysqli_num_rows($result1) > 0){
                                               ...
                                               for($i = 1; $i <= $total_page; $i++){
                                                      ...
                                                      echo"<li class='".$actives."'><a href='index.php?page=  ".$i."'> ".$i."</a></li>";
